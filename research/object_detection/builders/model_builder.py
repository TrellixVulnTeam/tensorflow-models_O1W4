...
from object_detection.models import faster_rcnn_mobilenet_v1_feature_extractor as frcnn_mobilenetv1
...
FASTER_RCNN_FEATURE_EXTRACTOR_CLASS_MAP = {
    ...
    frcnn_mobilenetv1.FasterRCNNMobilenetV1FeatureExtractor
}
